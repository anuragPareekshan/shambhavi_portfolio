$(document).ready(function () {
    $(document).ready(function () {
        ...
        function createBookPages() {
            ...
            const p8Parts = splitContentIntoBetterPages(p8Content, 12);
            ...
            const p9Content = $('#publication-9').find('.article-post').html();
            const p9Parts = splitContentIntoBetterPages(p9Content, 10);

            const p9Title = $('<div class="page"><div class="page-content">' +
                '<h1 class="posttitle">The Algorithm of Betaal: A Futuristic Tale of the Commonwealth</h1>' +
                '</div></div>');
            $('#book').append(p9Title);

            p9Parts.forEach(part => {
                if (part && part.trim() !== '') {
                    const page = $('<div class="page"><div class="page-content">' + part + '</div></div>');
                    $('#book').append(page);
                } else {
